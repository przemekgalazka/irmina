...
import com.geodevv.testing.sampledomain.impl.bmw.DiselEngine;

@ContextConfiguration(classes = SampleConfiguration.class, loader = SpyInjectionTest.ContextLoader.class)
@TestExecutionListeners(IrminaTestContextListener.class)
@RunWith(SpringJUnit4ClassRunner.class)
public class SpyInjectionTest {
    ...
    @Test
    public void shouldInjectSpyEngineForFordBmw() {

        // when
        bmw.start();

        //expect
        assertThat(engine).isInstanceOf(DiselEngine.class);
        verify(engine).turnOn();
    }
